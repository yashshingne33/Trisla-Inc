        ...
        <div className="container split" style={{ alignItems: 'flex-start' }}>
          <div>
            ...
            <div style={{ marginTop: 20 }}>
              <div className="contact-block"><div><h4>Address</h4><p>Trisla Inc.<br />Nagpur, Maharashtra, India</p></div></div>
              <div className="contact-block"><div><h4>Phone</h4><p>+91 98907 77000</p></div></div>
              <div className="contact-block"><div><h4>Business Email</h4><p>info@trislainc.com</p></div></div>
